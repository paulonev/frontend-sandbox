...
export const PortfolioCardCurrentMetrics = ({ gainLoss, totalAmount, currency = AppGlobalCurrencyCode, colorScheme }: IPortfolioCardCurrentMetricsProps) => {
    ...
    return (
        <>
            ...
            <SecondaryParagraphStyled isGain={isGain(gainLoss.type)} theme={theme} type={type}>
...
const SecondaryParagraphStyled = styled.p<{ theme: DefaultTheme; isGain: boolean; type: string}>`
    margin-top: 0;
    margin-bottom: 10px;
    font-weight: 500;

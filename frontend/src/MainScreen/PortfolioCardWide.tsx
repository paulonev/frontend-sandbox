...
export const PortfolioCardWide = ({ item, onClick }: IPortfolioCardWideProps): JSX.Element => {
    ...
    return (
        <ItemCard
            ...
            titleStyles={{
                color: theme.main.textColor ?? theme.card_default.textColor,
            }}
            ...
            secondaryParagraphStyles={{
                ...
                color: isGain(item.meta.gainLoss.type) 
                        ? theme.main.gainColor ?? theme.card_default.gainColor 
                        : theme.main.lossColor ?? theme.card_default.lossColor
            }}
            ...
            Footer={() => <PortfolioCardTags value={item?.tags} colorScheme={"main"} />}
        />
    );
}